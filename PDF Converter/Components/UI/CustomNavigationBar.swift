...
struct CustomNavigationBar: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(
                gradient: Gradient(colors: [Color(#colorLiteral(red: 0.0, green: 0.48, blue: 1.0, alpha: 1.0)), // насыщенный синий
                                            Color(#colorLiteral(red: 0.0, green: 0.56, blue: 1.0, alpha: 1.0))]), // чуть светлее
                startPoint: .top,
                endPoint: .bottom
            )
